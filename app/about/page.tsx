      ...
      <section className="section" aria-labelledby="story-heading">
        <div className="container">
          ...
          <div className="about-story reveal" style={{ marginTop: "40px", "--delay": "120ms" }}>
            ...
            <p>It now holds <strong>{stats.totalTools.toLocaleString()} AI tools</strong> across writing, coding, image generation, video, SEO, and a few dozen other categories, plus <strong>{stats.totalTech.toLocaleString()} developer technologies</strong> covering most of the stack. I add and check entries by hand. Nothing scraped, nothing paid for a spot.</p>
      ...
      <section className="cta-section" aria-labelledby="about-cta-heading">
        <div className="cta-card reveal">
          ...
          <div className="cta-inner">
            ...
            <p className="cta-sub">{stats.totalItems.toLocaleString()} tools and technologies, one fast catalog. No account needed.</p>
